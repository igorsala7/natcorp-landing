...
| `/apresentacao/reduzida` | A mesma apresentação em 17 slides, para a primeira conversa (cerca de 20 minutos). |
...
Em `/apresentacao` (completa, 31 slides, cerca de 45 minutos) e `/apresentacao/reduzida` (17 slides, cerca de 20 minutos). Fora do menu e do sitemap, com `noindex`: é um material compartilhado por link. Os slides encaixam na rolagem, um por tela; setas, espaço e Page Up/Down navegam; **F** liga a tela cheia, **N** as notas do apresentador, **G** o índice e **E** o menu de exportação. A posição fica na URL (`?s=N`), então o link pode abrir num slide específico.
