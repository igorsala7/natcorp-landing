...
const page: ModulePage = {
  ...
  seo: {
    ...
    description:
      'Admissão digital para grandes empresas: coleta eletrônica de dados e documentos, assinatura com validade jurídica e integração nativa com a folha. Zero digitação, zero retrabalho.',
  },
  highlights: [
    { value: '0', label: 'papel: dados, documentos e assinatura são digitais' },
    { value: '1 vez', label: 'o colaborador é cadastrado e já existe em todos os módulos' },
    { value: '100%', label: 'do fluxo no Portal do Candidato, no celular ou no computador' },
  ],
  benefits: [
    {
  ...
  features: [
    ...
    },
    {
      ...
      text: 'RG, CPF, comprovante de endereço, CNH, reservista, currículo e documentos de dependentes anexados e organizados digitalmente.',
      icon: 'folder',
    },
    {
