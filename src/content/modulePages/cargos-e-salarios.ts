...
const page: ModulePage = {
  ...
  highlights: [
    { value: '1 cadastro', label: 'de cargos, tabelas e faixas por empresa e sindicato' },
    { value: '5 passos', label: 'do pedido de reajuste à folha, com trava de política' },
  ],
  benefits: [
    {
  ...
  features: [
    ...
    },
    {
      ...
      text: 'Descrição sumária, atividades detalhadas, chefia imediata e orientações de segurança por local, com função ligada ao CBO (Classificação Brasileira de Ocupações) e associação em massa.',
      icon: 'file-text',
    },
    {
    ...
    },
    {
      ...
      text: 'Tabelas por empresa e sindicato, com grades e faixas, regras de mérito e promoção, visíveis por hora ou por mês, para apoiar decisões salariais com dados.',
      icon: 'table',
    },
    {
    ...
    },
    {
      ...
      text: 'Cenários de mérito ou acordo sindical, por empresa ou sindicato, com o impacto financeiro real na folha, ao lado do histórico salarial e das evoluções cadastrais.',
      icon: 'calculator',
    },
    {
  ...
  compliance: ['CBO nas funções e descrições de cargo', 'Periculosidade e cargo de confiança parametrizados por cargo', 'Acordos sindicais e dissídio nos cenários de reajuste'],
  personas: [
    { role: 'RH e Remuneração', text: 'Mantém estrutura de cargos, tabelas e faixas de todas as empresas em um só cadastro e simula reajustes antes de levar à diretoria.' },
  ...
  faq: [
    ...
    {
      q: 'Consigo ter tabelas salariais diferentes por empresa e sindicato?',
      a: 'Sim. Cada empresa e cada acordo sindical tem a sua tabela, com grades e faixas próprias, na mesma base. O dissídio de um sindicato é simulado e aplicado só onde vale, e a NATI compara a equidade entre as estruturas do grupo. Requisitos, competências e funções com CBO continuam alimentando o Recrutamento e Seleção, a carreira e as avaliações.',
    },
  ],
